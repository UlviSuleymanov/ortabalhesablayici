...
const EightSubject = () => {
  ...
  const bals =
    ...
    parseInt(input.bal8) * parseInt(input.kredit8);
    ...
    <div className="App">
      ...
      <div>
        <input
          ...
          onChange={(event) => {
            if (+event.target.value && event.target.value <= maxBal) {
              setInput({ ...input, bal8: event.target.value });
              setMsgError('');
            } else {
              setMsgError('51 ve 100 arasi reqem giriniz.');
            }
        ...
        <input
          ...
          onChange={(event) => {
            if (+event.target.value && event.target.value <= maxKredit) {
              setInput({ ...input, kredit8: event.target.value });
              setMsgError('');
            } else if (+event.target.value === 0) {
              setInput({ ...input, kredit8: 0 });
            } else {
              setMsgError('1 - 10 arasi reqem girniniz.');
            }
          }}
